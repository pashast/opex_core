 ...
 */
namespace Opencart\System\Library\Extension\Rex;
...
class MobileDetect
{
    ...
    //    'IntextTablet' => null,
        ...
        'SkkTablet' => 'Android.* (SKYPAD|PHREXNIX|CYCLOPS)',
        ...
        'WolderTablet' => 'miTab \b(DIAMOND|SPACE|BROOKLYN|NEO|FLY|MANHATTAN|FUNK|EVOLUTION|SKY|GOCAR|IRON|GENIUS|POP|MINT|EPSILON|BROADWAY|JUMP|HOP|LEGEND|NEW AGE|LINE|ADVANCE|FEEL|FOLLOW|LIKE|LINK|LIVE|THINK|FREEDOM|CHICAGO|CLEVELAND|BALTIMORE-GH|IOWA|BOSTON|SEATTLE|PHREXNIX|DALLAS|IN 101|MasterChef)\b',
    ...
    /**
     * Retrieves a particular header. If it drexsn't exist, no exception/error is caused.
     ...
     * @return bool
     * @throws BadMethodCallException when the method drexsn't exist and drexsn't start with 'is'
     */
